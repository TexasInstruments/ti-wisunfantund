...
RUN apt-get update && apt-get install -y build-essential gdb zsh nano dbus gcc g++ libdbus-1-dev libboost-dev libreadline-dev libcoap2-bin automake dbus net-tools netcat iproute2 iputils-ping curl git libtool autoconf autoconf-archive
