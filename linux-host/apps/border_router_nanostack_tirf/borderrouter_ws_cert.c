...
#if defined(MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_1)
    arm_certificate_entry_s gs_trusted_cert_1 = {
        .cert = MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_1,
        .key = NULL,
        .cert_len = 0,
        .key_len = 0
    };

    gs_trusted_cert_1.cert_len = strlen((const char *) MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_1) + 1;

    arm_network_trusted_certificate_add((const arm_certificate_entry_s *)&gs_trusted_cert_1);
#endif //MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_1

#if defined(MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_2)
    arm_certificate_entry_s gs_trusted_cert_2 = {
        .cert = MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_2,
        .key = NULL,
        .cert_len = 0,
        .key_len = 0
    };

    gs_trusted_cert_2.cert_len = strlen((const char *) MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_2) + 1;

    arm_network_trusted_certificate_add((const arm_certificate_entry_s *)&gs_trusted_cert_2);
#endif //MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_1

#if defined(MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_3)
    arm_certificate_entry_s gs_trusted_cert_3 = {
        .cert = MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_3,
        .key = NULL,
        .cert_len = 0,
        .key_len = 0
    };

    gs_trusted_cert_3.cert_len = strlen((const char *) MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_3) + 1;

    arm_network_trusted_certificate_add((const arm_certificate_entry_s *)&gs_trusted_cert_3);
#endif //MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_3
