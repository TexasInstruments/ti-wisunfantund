...
#define MBED_CONF_APP_CERTIFICATE_HEADER                                      "ws_br_fan_cert_certificates.h"
//#define MBED_CONF_APP_MCA_CERTIFICATE                                         WISUN_MCA_CERTIFICATE
//#define MBED_CONF_APP_MICA_CERTIFICATE                                        WISUN_MICA_CERTIFICATE
#define MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_1                                   WISUN_GS_ROOT_CERTIFICATE_1
#define MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_2                                   WISUN_GS_ROOT_CERTIFICATE_2
#define MBED_CONF_WISUN_GS_ROOT_CERTIFICATE_3                                   WISUN_GS_ROOT_CERTIFICATE_3
//#define MBED_CONF_APP_OWN_CERTIFICATE                                         WISUN_SERVER_CERTIFICATE_FROM_MICA
//#define MBED_CONF_APP_OWN_CERTIFICATE_KEY                                     WISUN_SERVER_CERTIFICATE_FROM_MICA_KEY
...
//#define MBED_CONF_APP_ROOT_CERTIFICATE                                        WISUN_GS_ROOT_CERTIFICATE_1
